...
- New/changed components: Responsive hook, mobile card layouts for table-heavy screens, Stock create/edit form reuse, Menu add-on/free-menu selectors, and Bot Messages conversation bubbles in a scrollable thread with newest messages at the bottom.
